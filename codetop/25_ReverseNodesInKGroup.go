...
func ReverseKGroup(head *common.ListNode, k int) *common.ListNode {
	...
	var nh *common.ListNode = reverse25(head, t)
...
func reverse25(h *common.ListNode, t *common.ListNode) *common.ListNode {
	// 翻转 h 和 t 之间的节点，左闭右开区间 [h,t)
	var p *common.ListNode = nil
	var n *common.ListNode = nil
